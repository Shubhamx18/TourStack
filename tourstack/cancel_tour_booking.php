...
$sql = "SELECT * FROM tour_bookings WHERE id = ? AND user_id = ?";
...
// Cancel the booking
$sql = "UPDATE tour_bookings SET booking_status = 'cancelled' WHERE id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $booking_id);

if ($stmt->execute()) {
    $_SESSION['booking_success'] = "Your tour booking has been successfully cancelled.";
} else {
