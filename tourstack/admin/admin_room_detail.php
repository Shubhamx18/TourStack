...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    ...
    header("Location: admin/simple_rooms.php");
    exit;
}
        ...
        <div class="admin-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="admin-header-actions">
                    <a href="admin/simple_rooms.php" class="btn btn-outline-secondary me-2">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="admin/admin_room_edit.php" method="post" id="editRoomForm">
...
<div class="modal fade" id="replyReviewModal" tabindex="-1" aria-labelledby="replyReviewModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="admin/admin_review_reply.php" method="post">
