...
if (isset($_POST['confirm_delete']) && $_POST['confirm_delete'] === 'YES') {
    ...
    $potential_constraint_tables = ['bookings', 'room_bookings', 'room_images', 'room_amenities', 'room_reviews'];
    $constraint_tables = [];
    ...
    try {
        ...
        foreach ($constraint_tables as $table) {
            $clear_query = "DELETE FROM $table WHERE room_id IN (SELECT id FROM rooms)";
        ...
        // Step 2: Remove all rooms
        $delete_rooms_query = "DELETE FROM rooms";
        $result = $conn->query($delete_rooms_query);
        
        if ($result) {
            $rooms_deleted = $conn->affected_rows;
            debug_to_console("Deleted $rooms_deleted rooms");
            
            // Commit transaction if all operations succeeded
            $conn->commit();
            $message = "Successfully removed $rooms_deleted rooms and $constraints_removed related records.";
        } else {
            throw new Exception("Error deleting rooms: " . $conn->error);
        }
...
<head>
    ...
    <title>Remove All Rooms - TOUR STACK Admin</title>
...
<body class="admin-body">
    <header>
        <h1 class="admin-page-title">Remove All Rooms</h1>
        ...
        <main class="admin-main">
            ...
            <section class="admin-section">
                <div class="section-header">
                    ...
                    <a href="admin/simple_rooms.php" class="back-btn">
                        <i class="fas fa-arrow-left"></i> Back to Rooms
                    </a>
                </div>
                
                <div class="danger-zone">
                    <h3><i class="fas fa-exclamation-triangle"></i> Remove All Rooms</h3>
                    
                    <div class="warning-text">
                        <p>WARNING: This action will remove ALL rooms from the database and cannot be undone!</p>
                        <p>This process will:</p>
                        <ul>
                            <li>Delete all related records in booking tables</li>
                            <li>Remove all room data</li>
                            <li>Clear any associated room images, amenities, reviews</li>
                        </ul>
                        <p>This is intended for resetting the system or cleaning up test data.</p>
                    </div>
                    
                    <div class="confirmation-box">
                        <form method="POST" onsubmit="return confirm('Are you ABSOLUTELY sure you want to delete ALL rooms? This cannot be undone!');">
