    ...
    <div class="admin-container">
        ...
        <aside class="admin-sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="admin/simple_packages.php" class="sidebar-nav-item active">
            ...
            <section class="admin-section">
                <div class="section-header">
                    ...
                    <div class="action-buttons">
                        <a href="admin/add_package.php" class="action-btn edit-btn" style="background-color: #28a745;">
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (data.message === 'Unauthorized access') {
                        ...
                        modalContent.innerHTML = '<p class="error">Your session has expired. <a href="admin/admin_index.php">Please login again</a>.</p>';
                    } else {
