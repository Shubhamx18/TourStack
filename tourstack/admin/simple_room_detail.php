...
<body class="admin-body">
    ...
    <div class="admin-container">
        ...
        <main class="admin-main">
            ...
            <?php if ($room): ?>
                <section class="admin-section">
                    <div class="section-header">
                        ...
                        <a href="admin/simple_rooms.php" class="action-btn back-btn">
            ...
            <?php else: ?>
                <div class="error-message">
                    <i class="fas fa-exclamation-circle"></i> Room not found. <a href="admin/simple_rooms.php">Return to rooms list</a>.
                </div>
            <?php endif; ?>
        </main>
    </div>
