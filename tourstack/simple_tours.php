            ...
            <section class="admin-section">
                <div class="section-header">
                    ...
                    <div class="action-buttons">
                        <a href="add_tour.php" class="action-btn edit-btn" style="background-color: #28a745;">
                            <i class="fas fa-plus"></i> Add New Tour
                        </a>
                        <a href="remove_all_tours.php" class="action-btn delete-btn" style="background-color: #e74c3c;">
