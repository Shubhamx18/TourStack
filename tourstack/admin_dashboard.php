    ...
    <div class="admin-container">
        ...
        <aside class="admin-sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="admin_dashboard.php" class="sidebar-nav-item active">
        ...
        <main class="admin-main">
            ...
            <section class="admin-section">
                ...
                <div class="chart-row">
                    <div class="chart-col">
                        <div class="chart-title">Monthly Bookings (<?php echo date('Y'); ?>)</div>
            ...
            <section class="admin-section">
                ...
                <div class="view-all">
                    <a href="admin_bookings.php" class="view-all-btn">View All Bookings</a>
                </div>
            </section>
        </main>
    </div>
