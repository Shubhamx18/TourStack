        ...
        <main class="admin-main">
            ...
            <section class="admin-section">
                <div class="section-header">
                    ...
                    <div>
                        <a href="add_room.php" class="action-btn edit-btn" style="background-color: #28a745;">
                            <i class="fas fa-plus"></i> Add New Room
                        </a>
                        <a href="remove_all_rooms.php" class="action-btn delete-btn" style="background-color: #e74c3c;">
